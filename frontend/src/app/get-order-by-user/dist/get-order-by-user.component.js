...
exports.GetOrderByUserComponent = void 0;
var core_1 = require("@angular/core");
var GetOrderByUserComponent = /** @class */ (function () {
    function GetOrderByUserComponent(_Activatedroute, orderService, restaurantService, userService, orderDetailsService, dishesService, deliveryService) {
    ...
    GetOrderByUserComponent.prototype.ngOnInit = function () {
    ...
    GetOrderByUserComponent.prototype.GetOrderByIdOrder = function () {
        var _this = this;
    ...
    GetOrderByUserComponent.prototype.GetRestaurantByIdRestaurant = function (id_restaurant) {
        var _this = this;
        this.sub = this._Activatedroute.paramMap.subscribe(function (params) {
    ...
    GetOrderByUserComponent.prototype.GetUserByIdUser = function (id_user) {
        var _this = this;
        this.sub = this._Activatedroute.paramMap.subscribe(function (params) {
    ...
    // }
    GetOrderByUserComponent.prototype.GetOrderDetailsByIdOrder = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                this.sub = this._Activatedroute.paramMap.subscribe(function (params) {
    ...
    GetOrderByUserComponent.prototype.GetDeliveryByIdOrder = function () {
        // this.sub = this._Activatedroute.paramMap.subscribe(  (params) => {
    ...
    GetOrderByUserComponent = __decorate([
        core_1.Component({
    ...
    return GetOrderByUserComponent;
}());
exports.GetOrderByUserComponent = GetOrderByUserComponent;
