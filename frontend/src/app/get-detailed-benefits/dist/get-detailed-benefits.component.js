...
exports.GetDetailedBenefitsComponent = void 0;
var core_1 = require("@angular/core");
var GetDetailedBenefitsComponent = /** @class */ (function () {
    function GetDetailedBenefitsComponent(orderService, deliveryService, restaurantService, _Activatedroute, _router) {
    ...
    GetDetailedBenefitsComponent.prototype.ngOnInit = function () {
        this.GetOrder();
    };
    GetDetailedBenefitsComponent.prototype.GetOrder = function () {
        var _this = this;
                ...
                _this.sub = _this._Activatedroute.paramMap.subscribe(function (params) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        this.restaurantService
                            ...
                            var created_date, months, year, month, date;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        this.restaurantService;
    ...
    GetDetailedBenefitsComponent = __decorate([
        core_1.Component({
    ...
    return GetDetailedBenefitsComponent;
}());
exports.GetDetailedBenefitsComponent = GetDetailedBenefitsComponent;
