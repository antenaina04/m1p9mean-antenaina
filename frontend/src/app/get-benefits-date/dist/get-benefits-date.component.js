...
exports.GetBenefitsDateComponent = void 0;
var core_1 = require("@angular/core");
var GetBenefitsDateComponent = /** @class */ (function () {
    function GetBenefitsDateComponent(orderService, deliveryService, restaurantService, _Activatedroute, _router) {
    ...
    GetBenefitsDateComponent.prototype.ngOnInit = function () {
        this.GetOrder();
    };
    GetBenefitsDateComponent.prototype.GetOrder = function () {
        var _this = this;
                ...
                _this.sub = _this._Activatedroute.paramMap.subscribe(function (params) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        this.restaurantService
                            ...
                            var created_date, months, year, month, date, result;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        this.restaurantService;
                                    ...
                                    case 2:
                                        ...
                                        _a.label = 3;
                                    case 3:
                                        result = ObjList === null || ObjList === void 0 ? void 0 : ObjList.reduce(function (acc, obj) {
    ...
    GetBenefitsDateComponent = __decorate([
        core_1.Component({
    ...
    return GetBenefitsDateComponent;
}());
exports.GetBenefitsDateComponent = GetBenefitsDateComponent;
